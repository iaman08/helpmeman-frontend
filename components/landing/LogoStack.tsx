  ...
  /* ── Apple ── */
  {
    ...
    icon: (
      ...
      >
        <path
          fill="white"
          d="M16.365 1.43c0 1.14-.415 2.09-1.245 2.85-.945.9-2.09 1.42-3.315 1.32-.015-.135-.03-.27-.03-.42 0-1.095.48-2.265 1.29-3 .405-.375.93-.69 1.575-.945A5.1 5.1 0 0116.365 1.43ZM19.485 17.355c-.36.825-.78 1.59-1.275 2.31-.675.975-1.23 1.65-1.665 2.025-.675.615-1.395.93-2.175.945-.555 0-1.23-.165-2.01-.51-.78-.33-1.5-.495-2.145-.495-.675 0-1.41.165-2.205.495-.795.345-1.44.525-1.92.54-.75.03-1.5-.3-2.25-.99-.48-.42-1.065-1.125-1.74-2.115-.72-1.02-1.305-2.205-1.77-3.57-.495-1.47-.75-2.895-.75-4.275 0-1.575.33-2.94 1.02-4.095.54-.93 1.26-1.665 2.16-2.205a5.72 5.72 0 012.895-.84c.57 0 1.32.18 2.25.54.93.36 1.53.54 1.8.54.195 0 .855-.21 1.98-.63 1.065-.39 1.965-.555 2.7-.495 1.995.165 3.495.96 4.485 2.385-1.785 1.08-2.67 2.595-2.655 4.545.015 1.515.555 2.775 1.635 3.78.48.465 1.02.825 1.62 1.08-.135.39-.285.765-.45 1.125Z"
        />
      </svg>
    ),
  },
