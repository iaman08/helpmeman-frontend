              ...
              mode === "signin" ? (
                <>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2.5 rounded-lg border border-gray-300 dark:border-zinc-700 py-2.5 text-[13px] font-medium hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors cursor-pointer bg-transparent text-[var(--fg)] shadow-sm"
                  >
                  ...
                  {/* Demo Login details component inside modal */}
                  <details className="w-full mt-5 group border border-gray-200/60 dark:border-zinc-800 rounded-xl overflow-hidden">
                    <summary className="flex items-center justify-between px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-[var(--muted)] cursor-pointer select-none bg-gray-50 dark:bg-zinc-900/60 hover:bg-gray-100/60 dark:hover:bg-zinc-800/80 transition-colors">
                      <span>Quick Demo Access</span>
                      <span className="text-[9px] text-[var(--muted)] transition-transform duration-200 group-open:rotate-180">▼</span>
                    </summary>
                    <div className="p-3 bg-white dark:bg-[#121214] grid grid-cols-3 gap-1.5 border-t border-gray-100 dark:border-zinc-800">
                      <button
                        type="button"
                        onClick={() => handleDemoAccess("admin@helpmeman.com", "password123")}
                        className="flex flex-col items-center p-2 rounded-lg bg-[var(--fg)]/5 hover:bg-[var(--fg)]/8 border border-transparent transition-all text-center cursor-pointer"
                      >
                        <span className="text-[10px] font-bold text-[var(--fg)]">Admin</span>
                      </button>
                      <button
                        type="button"
                        ...
                        className="flex flex-col items-center p-2 rounded-lg bg-[var(--fg)]/5 hover:bg-[var(--fg)]/8 border border-transparent transition-all text-center cursor-pointer"
                      >
                        <span className="text-[10px] font-bold text-[var(--fg)]">Mentor</span>
                      </button>
                      <button
                        type="button"
                        ...
                        className="flex flex-col items-center p-2 rounded-lg bg-[var(--fg)]/5 hover:bg-[var(--fg)]/8 border border-transparent transition-all text-center cursor-pointer"
                      >
                        <span className="text-[10px] font-bold text-[var(--fg)]">User</span>
                      </button>
                    </div>
                  </details>
