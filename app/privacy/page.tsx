          ...
          <div className="space-y-6 text-sm sm:text-base leading-relaxed">
            ...
            <section className="space-y-3">
              ...
              <ul className="list-disc pl-5 space-y-2 text-zinc-600 text-sm">
                <li>
                  <strong className="text-zinc-900 font-semibold">Google Sign-In (OAuth 2.0):</strong> Facilitates account creation and secure logins via Google OAuth without storing your Google credentials.
                </li>
                <li>
                  <strong className="text-zinc-900 font-semibold">Google Calendar &amp; Meet:</strong> Automates scheduling and generates unique, secure conference links for video sessions.
                </li>
                <li>
                  <strong className="text-zinc-900 font-semibold">Web Push Notifications:</strong> Sends real-time device push notifications for session bookings and updates using the standard browser Push API.
                </li>
                <li>
                  <strong className="text-zinc-900 font-semibold">Razorpay Payment Gateway:</strong> Securely processes payments, validates receipts, and processes refunds.
                </li>
                <li>
                  <strong className="text-zinc-900 font-semibold">Supabase Storage:</strong> Stores and delivers user avatars, mentor display pictures, and identity screening credentials.
                </li>
                <li>
                  <strong className="text-zinc-900 font-semibold">Brevo SMTP Service:</strong> Dispatches platform transaction emails, signup verification codes, and alerts.
                </li>
              </ul>
            </section>
            ...
            <section id="dpdp" className="space-y-4 pt-6 border-t border-zinc-200 scroll-mt-32">
              ...
              <div className="space-y-4 mt-3">
                ...
                <div className="p-4 rounded-2xl bg-amber-500/5 border border-amber-500/20">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-zinc-700 bg-white p-3 rounded-xl border border-zinc-200">
                    <div>
