      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex flex-col gap-1.5">
          <p className="text-xs uppercase tracking-[0.22em] flex items-center gap-2" style={{ color: "var(--muted)" }}>
            ...
            Super Admin Access Trail
          </p>
          <h1 className="font-display text-4xl leading-tight" style={{ color: "var(--fg)" }}>
            Security Audit Logs.
          </h1>
          <p className="text-sm" style={{ color: "var(--muted)" }}>
            Full immutable ledger of platform access, device fingerprints, and unauthorized threat attempts.
          </p>
        </div>
              ...
              <div className="flex items-center justify-between pt-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-2 rounded-xl border border-[var(--hairline)] disabled:opacity-40 hover:bg-white/5"
                  >
