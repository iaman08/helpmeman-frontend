        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-violet-600 hover:bg-violet-700 text-white rounded-xl text-xs font-semibold cursor-pointer shadow transition-transform active:scale-[0.98]"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold cursor-pointer transition-colors border"
              style={{
                ...
                searchResults.map((u) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="px-3.5 py-1.5 bg-violet-600 hover:bg-violet-700 disabled:opacity-50 text-white rounded-lg text-xs font-semibold cursor-pointer shadow transition-colors flex items-center gap-1.5"
                    >
                      {promotingId === u.id ? (
                        <>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="p-1 rounded-lg hover:bg-black/5 dark:hover:bg-white/5 cursor-pointer text-[var(--muted)]"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
          <form onSubmit={handleCreate} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2 flex justify-end gap-2 mt-2">
              ...
              <button
                type="submit"
                className="px-5 py-2 bg-violet-600 hover:bg-violet-700 text-white text-xs font-semibold rounded-xl cursor-pointer shadow"
              >
                        ...
                        {isSuperAdmin ? (
                          ...
                          <div className="flex items-center justify-end gap-2">
                            <button
                              ...
                              className="text-xs bg-emerald-500/10 text-emerald-600 px-3 py-1 rounded font-semibold cursor-pointer"
                            >
                              Save
                            </button>
                            <button
                          ...
                          <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                            <button
                              ...
                              className="p-1.5 text-rose-500 hover:bg-rose-500/15 rounded transition-colors cursor-pointer"
