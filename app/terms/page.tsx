      ...
      <main className="flex-1 mx-auto max-w-[800px] px-6 sm:px-10 pt-28 pb-16 w-full text-zinc-700">
        ...
        <div className="space-y-6 text-sm sm:text-base leading-relaxed">
          ...
          <section className="space-y-3 pt-4">
            <h2 className="text-lg font-semibold text-zinc-900">1. Platform Overview</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-zinc-900">2. Eligibility & Accounts</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-zinc-900">3. User Code of Conduct</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-zinc-900">4. Bookings & Payments</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-zinc-900">7. Governing Law</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-zinc-900">8. Amendments</h2>
            <p>
